 ...
 */
export function getSkillMdSystemPrompt() {
 ...
 */
export function getSkillMdUserPrompt(description, skillType) {
 ...
 */
export function getSkillJsonSystemPrompt() {
 ...
 */
export function getSkillJsonUserPrompt(description, skillName) {
 ...
 */
export function getScriptSystemPrompt(language) {
    const configs = {
        typescript: {
            file: 'main.ts',
        },
 ...
 */
export function getScriptUserPrompt(description, skillName, language) {
 ...
 */
export function getReferenceSystemPrompt() {
 ...
 */
export function getReferenceUserPrompt(serviceName, description) {
 ...
 */
export function getClassifierPrompt(description) {
