 ...
 */
export async function generateScript(options: ScriptOptions): Promise<{ fileName: string; content: string }> {
 ...
 */
export function generateToolsHelper(language: 'typescript' | 'javascript'): string {
